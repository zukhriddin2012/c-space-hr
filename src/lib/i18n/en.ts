...
export const en: Translations = {
  ...
  settings: {
    ...
    receptionConfigDesc: 'Manage ServiceHub configuration: service types, expenses, payment methods, operator PINs, and kiosk access.',
  ...
  reception: {
    ...
    temporary: 'Temporary',
    regular: 'Regular',
    permanentTransfer: 'Transfer',
    assignToSBranch: 'Assign to Branch',
    startsAt: 'Starts At',
    endsAt: 'Ends At',
    assignedBy: 'Assigned By',
    homeBranch: 'Home Branch',
    assignedTo: 'Assigned To',
    endAssignmentConfirm: 'Are you sure you want to end this assignment?',
    accessAutoRevoked: 'Auto-granted access will be revoked',
    noActiveAssignments: 'No active assignments',
    assignEmployeesToBranches: 'Assign employees to branches for cross-branch coverage',
    ...
    assignmentToday: 'Today',
    operatingAtBranch: 'Operating at',
    assignedTag: 'ASSIGNED',
    grantedTag: 'GRANTED',
    assignmentEndsSoon: 'Assignment ends soon',
    branchBriefing: 'Branch Briefing',
    todaysBriefing: "Today's Briefing",
    briefingOperators: 'Operators',
    briefingCrossBranch: 'cross-branch',
    briefingRecentActivity: 'Recent Activity',
    briefingTransactions: 'Transactions',
    briefingExpenses: 'Expenses',
    briefingServices: 'services',
    briefingExpenseTypes: 'expense types',
    briefingPaymentMethods: 'payment methods',
    briefingToday: 'today',
    branchInfo: 'Branch Info',
    assignmentEndsTomorrow: 'Assignment ends tomorrow',
    assignmentEndsInDays: 'Assignment ends in {days} days',
    endsOn: 'Ends {date}',
  ...
  operatorSwitch: {
    ...
    notFromThisBranch: 'Not from this branch?',
    findOperator: 'Find Operator',
    searchOtherBranches: 'Search other branches',
    confirmIdentity: 'Confirm Identity',
    typeYourPin: 'Type your PIN using the keyboard',
    incorrectPin: 'Incorrect PIN',
    accountLockedFor: 'Account locked for {seconds}s',
  ...
  cashManagement: {
    ...
    selectBranch: 'Select a branch to view cash management',
    thresholdExceeded: 'Transfer threshold exceeded',
    thresholdExceededDesc: 'Non-inkasso cash balance exceeds the threshold. GM should collect from Reception Safe.',
    opex: 'OpEx',
    marketing: 'Marketing',
    dividend: 'Dividend',
    fixed: 'Fixed',
    ...
    sinceLastTransfer: 'Since last transfer',
    inkassoPending: 'Inkasso Pending',
    inkassoDelivered: 'Inkasso Delivered',
    dividendRequests: 'Dividend Requests',
    inkassoDeliveries: 'Inkasso Deliveries',
    pendingDelivery: 'Pending Delivery',
    safeTransfers: 'Safe Transfers',
    receptionSafe: 'Reception Safe',
    mainSafe: 'Main Safe',
    recordTransfer: 'Record Transfer',
    transferHistory: 'Transfer History',
    deliveryHistory: 'Delivery History',
    confirmDelivery: 'Confirm Delivery',
    confirmDeliveryDesc: 'You are about to mark transactions as delivered to tax authorities.',
    deliveryIrreversible: 'This action cannot be undone. Delivered transactions cannot be re-delivered.',
    markAsDelivered: 'Mark as Delivered',
    selectAll: 'Select all',
    selected: 'selected',
    gmOnly: 'Only the General Manager can record safe transfers.',
    newRequest: 'New Request',
    submitRequest: 'Submit Request',
    requestDividendSpend: 'Request Dividend Spend',
    opexAvailable: 'OpEx available',
    dividendAvailable: 'Dividend available',
    fundingBreakdown: 'Funding Breakdown',
    fromOpex: 'From OpEx',
    fromDividend: 'From Dividend (needs approval)',
    ...
    marketingPercentage: 'Marketing percentage',
