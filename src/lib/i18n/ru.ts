...
export const ru: Translations = {
  ...
  nav: {
    ...
    operations: 'Операции',
    strategy: 'Стратегия',
    systemAdoption: 'Адаптация системы',
  ...
  settings: {
    ...
    receptionConfigDesc: 'Управление конфигурацией ServiceHub: типы услуг, расходов, методы оплаты, PIN-коды операторов и доступ.',
  ...
  reception: {
    ...
    branchAssignments: 'Назначения в филиалы',
    newAssignment: 'Новое назначение',
    bulkAssign: 'Массовое назначение',
    endAssignment: 'Завершить назначение',
    assignmentType: 'Тип назначения',
    temporary: 'Временное',
    regular: 'Постоянное',
    permanentTransfer: 'Перевод',
    assignToSBranch: 'Назначить в филиал',
    startsAt: 'Начало',
    endsAt: 'Окончание',
    assignedBy: 'Назначил',
    homeBranch: 'Домашний филиал',
    assignedTo: 'Назначен в',
    endAssignmentConfirm: 'Вы уверены, что хотите завершить назначение?',
    accessAutoRevoked: 'Автоматический доступ будет отозван',
    noActiveAssignments: 'Нет активных назначений',
    assignEmployeesToBranches: 'Назначьте сотрудников в филиалы для межфилиального покрытия',
    createFirstAssignment: 'Создать первое назначение',
    byBranch: 'По филиалу',
    byEmployee: 'По сотруднику',
    allTypes: 'Все типы',
    searchByName: 'Поиск по имени...',
    daysLeft: 'дней осталось',
    assignmentExpired: 'Истекло',
    assignmentToday: 'Сегодня',
    operatingAtBranch: 'Работа в',
    assignedTag: 'НАЗНАЧЕН',
    grantedTag: 'ДОСТУП',
    assignmentEndsSoon: 'Назначение скоро заканчивается',
    branchBriefing: 'Сводка филиала',
    todaysBriefing: 'Сводка за сегодня',
    briefingOperators: 'Операторы',
    briefingCrossBranch: 'межфилиальный',
    briefingRecentActivity: 'Последняя активность',
    briefingTransactions: 'Транзакции',
    briefingExpenses: 'Расходы',
    briefingServices: 'услуг',
    briefingExpenseTypes: 'типов расходов',
    briefingPaymentMethods: 'способов оплаты',
    briefingToday: 'сегодня',
    branchInfo: 'Инфо о филиале',
    assignmentEndsTomorrow: 'Назначение истекает завтра',
    assignmentEndsInDays: 'Назначение истекает через {days} дн.',
    endsOn: 'Истекает {date}',
    assignedOperators: 'Назначенные операторы',
    fromBranch: 'из {branch}',
  ...
  operatorSwitch: {
    ...
    notFromThisBranch: 'Не из этого филиала?',
    findOperator: 'Найти оператора',
    searchOtherBranches: 'Поиск по другим филиалам',
    confirmIdentity: 'Подтвердите личность',
    typeYourPin: 'Введите PIN с клавиатуры',
    incorrectPin: 'Неверный PIN',
    accountLockedFor: 'Аккаунт заблокирован на {seconds} сек.',
  ...
  metronome: {
    title: 'Метроном Синк',
    subtitle: 'Трекер инициатив руководства',
    daysToSync: 'Дней до синка',
    openDecisions: 'Открытые решения',
    overdue: 'Просрочено',
    onTrack: 'В графике',
    active: 'Активные',
    lastSync: 'Последний синк',
    nextSync: 'Следующий синк',
    startSync: 'Начать синк',
    downloadBrief: 'Скачать сводку',
    ...
    decided: 'Решено',
    defer: 'Отложить',
    whatWasDecided: 'Что было решено?',
    confirm: 'Подтвердить',
    cancel: 'Отменить',
    allDecisionsResolved: 'Все решения приняты',
    ...
    moreInitiatives: 'ещё инициатив',
    lead: 'Ответственный',
    upcoming: 'Предстоящие',
    thisWeeksFocus: 'Фокус этой недели',
    ...
    meeting: {
      title: 'Синк руководства',
      elapsed: 'Прошло',
      agenda: 'Повестка',
      progress: 'Прогресс',
      discussed: 'Обсуждено',
      markDiscussed: 'Отметить обсуждённым',
      nextItem: 'Следующий пункт',
      notes: 'Заметки',
      quickDecisions: 'Быстрые решения',
      endMeeting: 'Завершить встречу',
      endSummary: 'Итоги встречи',
      duration: 'Длительность',
      itemsDiscussed: 'Обсуждено пунктов',
      decisionsMade: 'Принято решений',
      actionItemsDone: 'Выполнено задач',
      attendees: 'Участники',
      nextSyncDate: 'Дата следующего синка',
      nextSyncFocus: 'Фокус следующего синка',
    ...
    empty: {
      noInitiatives: 'Нет инициатив',
      noDecisions: 'Нет ожидающих решений',
      noKeyDates: 'Нет ключевых дат в этом месяце',
      noActionItems: 'Нет задач',
    },
  },
  cashManagement: {
    title: 'Управление наличными',
    selectBranch: 'Выберите филиал для просмотра',
    thresholdExceeded: 'Порог перевода превышен',
    thresholdExceededDesc: 'Наличные без инкассо превышают порог. GM должен забрать из кассы рецепции.',
    opex: 'OpEx',
    marketing: 'Маркетинг',
    dividend: 'Дивиденд',
    fixed: 'Фиксированный',
    ...
    sinceLastTransfer: 'С последнего перевода',
    inkassoPending: 'Инкассо ожидает',
    inkassoDelivered: 'Инкассо сдано',
    dividendRequests: 'Запросы на дивиденд',
    inkassoDeliveries: 'Сдача инкассо',
    pendingDelivery: 'Ожидает сдачи',
    safeTransfers: 'Переводы в сейф',
    receptionSafe: 'Касса рецепции',
    mainSafe: 'Главный сейф',
    recordTransfer: 'Записать перевод',
    transferHistory: 'История переводов',
    deliveryHistory: 'История сдачи',
    confirmDelivery: 'Подтвердить сдачу',
    confirmDeliveryDesc: 'Вы собираетесь отметить транзакции как сданные в налоговую.',
    deliveryIrreversible: 'Это действие нельзя отменить. Сданные транзакции нельзя сдать повторно.',
    markAsDelivered: 'Отметить как сдано',
    selectAll: 'Выбрать все',
    selected: 'выбрано',
    gmOnly: 'Только генеральный менеджер может записывать переводы.',
    newRequest: 'Новый запрос',
    submitRequest: 'Отправить запрос',
    requestDividendSpend: 'Запрос траты из дивиденда',
    opexAvailable: 'Доступно в OpEx',
    dividendAvailable: 'Доступно в дивиденде',
    fundingBreakdown: 'Разбивка финансирования',
    fromOpex: 'Из OpEx',
    fromDividend: 'Из дивиденда (нужно одобрение)',
    ...
    approved: 'Одобрено',
    rejected: 'Отклонено',
    settings: 'Настройки наличных',
    marketingPercentage: 'Процент маркетинга',
