...
export interface Translations {
  ...
  reception: {
    ...
    assignToSBranch: string;
    startsAt: string;
    endsAt: string;
    assignedBy: string;
    homeBranch: string;
    assignedTo: string;
    endAssignmentConfirm: string;
    accessAutoRevoked: string;
    noActiveAssignments: string;
    assignEmployeesToBranches: string;
    ...
    operatingAtBranch: string;
    assignedTag: string;
    grantedTag: string;
    assignmentEndsSoon: string;
    branchBriefing: string;
  ...
  cashManagement: {
    ...
    available: string;
    totalCash: string;
    sinceLastTransfer: string;
    inkassoPending: string;
    inkassoDelivered: string;
    dividendRequests: string;
    inkassoDeliveries: string;
    pendingDelivery: string;
    safeTransfers: string;
    receptionSafe: string;
    mainSafe: string;
    recordTransfer: string;
    transferHistory: string;
    deliveryHistory: string;
    confirmDelivery: string;
    confirmDeliveryDesc: string;
    deliveryIrreversible: string;
    ...
    requestDividendSpend: string;
    opexAvailable: string;
    dividendAvailable: string;
